...
def blog_list(blog_id):
    ...
    return render_template("blog_list.html", blog_id=blog_id)
...
def filter():
    ...
    return render_template("filter.html", user=user, sysTime=sysTime)
...
def article_add():
    ...
    article2.author = TestUser.query.get(2)
