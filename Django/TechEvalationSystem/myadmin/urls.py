...
urlpatterns = [
    ...
    path('stu_edit/<str:xuehao_id>', views.stu_edit),  # 编辑学生
    path('stu_del/<str:xuehao_id>', views.stu_del, name='myadmin_stu_del'),  # 删除学生
    ...
    path('teachers_upload/', views.teachers_upload, name='myadmin_teacher_upload'),  # 上传信息
    path('teachers_toupload/', views.teachers_toupload, name='myadmin_teacher_toupload'),  # 查看上传的信息
