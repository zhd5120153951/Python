...
def my_letter_box(img, size=(640, 640)):
    ...
    img = cv2.copyMakeBorder(img_resize,
                             top,
                             bottom,
                             left,
                             right,
...
def cv2ImgAddText(img, text, left, top, textColor=(0, 255, 0), textSize=20):
    ...
    fontText = ImageFont.truetype("fonts/platech.ttf", textSize, encoding="utf-8")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--detect_model',
                        type=str,
                        default=r'weights/openvino/plate_detect.onnx',
                        help='model.pt path(s)')  #检测模型
    parser.add_argument('--rec_model', type=str, default='weights/openvino/plate_rec.onnx',
